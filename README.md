This is my project in web development, where I created a simple website to display a list of movies without using API integration. This project only uses basic HTML, CSS, and JavaScript.
